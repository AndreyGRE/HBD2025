        ...
        <div className="mt-[100px]  xl:mt-[240px] relative xl:mx-[240px] mx-[27px]">
            ...
            <div className="flex flex-col flex-wrap gap-[10px] xl:gap-8 gap-y-[40px] xl:mt-[64px] mt-[24px] items-center">
                <div className="flex flex-wrap items-center justify-center gap-[30px] xl:gap-[89px]">
                    <div className="flex flex-wrap items-center justify-center gap-[30px] xl:gap-[89px]">
                        <img src={imageGal1} className="w-19 lg:w-22 xl:w-auto"></img>
                        <img src={imageGal2} className="w-19 lg:w-22 xl:w-auto"></img>
                    </div>
                    <div className="flex flex-wrap items-center justify-center gap-[30px] xl:gap-[89px]">
                        <img src={imageGal3} className="w-19 lg:w-22 xl:w-auto"></img>
                        <img src={imageGal4} className="w-19 lg:w-22 xl:w-auto"></img>
                        <img src={imageGal5} className="w-19 lg:w-22 xl:w-auto"></img>
                    </div>
                    <div className="hidden xl:flex flex-wrap items-center justify-center gap-[30px] xl:gap-[89px] ">
                        <img src={imageGal6} className="w-19 lg:w-22 xl:w-auto"></img>
                    </div>
                </div>
                <div className="flex flex-wrap items-center  justify-center gap-[40px] gap-y-[30px] xl:gap-[69px]">
                    <div className="flex flex-wrap items-center  justify-center gap-[40px] gap-y-[30px] xl:gap-[69px]">
                        <img src={imageGal6}  className="w-16 lg:w-22 xl:w-auto block xl:hidden"></img>
                        <img src={imageGal21} className="w-16 lg:w-22 xl:w-auto"></img>
                        <img src={imageGal22} className="w-16 lg:w-22 xl:w-auto"></img>
                        <img src={imageGal23} className="w-16 lg:w-22 xl:w-auto"></img>
                    </div> 
                    <div className="flex flex-wrap items-center  justify-center gap-[40px] gap-y-[30px] xl:gap-[69px]">
                        <img src={imageGal24} className="w-16 lg:w-22 xl:w-auto"></img>
                        <img src={imageGal25} className="w-16 lg:w-22 xl:w-auto"></img>
                        <img src={imageGal26} className="w-16 lg:w-22 xl:w-auto"></img>
                        <img src={imageGal27} className="w-16 lg:w-22 xl:w-auto"></img>
                    </div>
                </div>
                <div className="flex items-center  justify-center gap-[40px] xl:gap-[45px]">
                    <img src={imageGal31} className="w-19 lg:w-22 xl:w-auto"></img>
                    <img src={imageGal32} className="w-19 lg:w-22 xl:w-auto"></img>
                    <img src={imageGal33} className="w-19 lg:w-22 xl:w-auto"></img>
                </div>
