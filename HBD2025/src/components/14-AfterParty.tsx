            ...
            <div className="bg-Af bg-contain bg-no-repeat text-white 2xl:ml-[211px] pl-[27px] 2xl:mr-[174px] 2xl:pt-[44px] pt-[42px] relative">
                <div className="relative">
                    ...
                    <div className="absolute lg:left-180 lg:-top-20 xl:left-220 xl:-top-30  2xl:left-250 2xl:-top-30 top-146 right-0 max-w-[180px] flex flex-col items-end ">
                        <img src={AfImg} className="2xl:max-w-[450px] lg:max-w-[300px] xl:max-w-[350px]  " />
                        <img
                            src={AfImg2}
                ...
                <div className="flex flex-col lg:flex-row items-start gap-[230px] lg:gap-[34px]  xl:gap-[64px]  lg:pt-[35px] lg:pb-[34px] pt-[65px] pb-[64px]">
                    ...
                    <div className="cursor-pointer flex gap-2 bg-[#E95521] -skew-x-17 rounded-lg lg:px-[31px] xl:py-[10px] w-8/9 lg:w-fit  py-[10px] items-center justify-center text-white text-[20px] xl:text-[24px] font-[450] hover:opacity-80 overflow-hidden">
