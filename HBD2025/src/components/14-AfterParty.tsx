...
function AfterParty() {
   useEffect(() => {
    ...
    return (
        <div
            id="AfterParty"
            className="px-[0px] mt-[100px] lg:mx-auto xl:mt-[234px] lg:max-w-[1000px] xl:max-w-[1200px] 2xl:max-w-full  2xl:ml-[0px] "
        >
            ...
            <div className="bg-Af bg-contain bg-no-repeat text-white 2xl:mx-[320px] pl-[27px] 2xl:mr-[0px] 2xl:pt-[44px] pt-[42px] relative ">
                <div className="relative 2xl:w-fit 2xl:min-w-[1200px]">
                    <div className="flex flex-col gap-[30px] w-fit  relative">
                        <p className="text-[67px] lg:text-[70px] xl:text-[90px]  2xl:text-[120px] font-[750] xl:leading-[100px] leading-[40px] max-w-[440px]">
                            AFTER
                        </p>
                        <p className="text-[67px] lg:text-[70px] xl:text-[90px]  2xl:text-[120px] font-[750] xl:leading-[100px] leading-[40px] lg:ml-[90px] xl:ml-[150px] 2xl:ml-[220px] max-w-[440px]">
                            PARTY
                        </p>
                    ...
                    <div className="absolute lg:left-180 lg:-top-20 xl:left-220 xl:-top-30  2xl:left-250 2xl:-top-30 top-146 right-0 max-w-[180px] flex flex-col items-end ">
                        ...
                        <img
                            src={AfImg2}
                            className="lg:max-w-[450px] xl:max-w-[600px] 2xl:max-w-[550px] xl:mt-[80px] max-w-[350px] mt-[50px] pr-[27px]"
                        />
                    </div>
                </div>
                <div className="flex flex-col lg:flex-row items-start gap-[230px] lg:gap-[34px] lg:pr-0 pr-[20px]   xl:gap-[64px]  lg:pt-[35px] lg:pb-[34px] pt-[45px] pb-[64px] w-full lg:w-fit">
                    ...
                    <div className="cursor-pointer flex gap-2 bg-[#E95521] -skew-x-17 rounded-lg lg:px-[31px]  xl:py-[10px] w-full px-4 lg:w-fit  py-[10px] items-center justify-center text-white text-[20px] xl:text-[24px] font-[450] hover:opacity-80 overflow-hidden">
                        <a className="skew-x-17 font-[100] uppercase text-center w-full" href="#AfterPartyTickets">
                            билет на афтерпати
                        </a>
                    </div>
                </div>
