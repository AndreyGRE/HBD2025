        ...
        `}
            >
                <div className="skew-x-9 xl:skew-x-7 flex flex-col h-full items-center">
                    <div className="flex flex-col justify-center flex-1 relative xl:w-full w-full items-center">
                        <img
                            src={srcImg}
                            alt="Speaker Photo"
                            className={`object-cover max-h-[130px] lg:max-h-[250px] ${
                                index == 0
                                    ? "2xl:max-h-[250px]"
                                    : "2xl:max-h-[300px]  "
                            }  2xl:max-w-[380px]  `}
                        ...
                        <a className=" absolute xl:-top-5 xl:-right-10 -top-2 -right-2 ">
                            {url ? (
                                <svg
                                    onClick={(e) => {
                                        e.preventDefault();
                                    ...
                                    className="xl:mr-10 cursor-pointer w-10 h-10 xl:w-12 xl:h-12"
                                    viewBox="0 0 56 56"
                                    fill="none"
                                >
