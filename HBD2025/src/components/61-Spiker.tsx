...
function Speaker({ srcImg, text1, text2, text3, url }: speaker) {
    return (
        <div className=" bg-[#05042E] py-6 pl-6 min-w-[360px] min-h-[309px] mt-[75px] xl:mt-[100px] relative ">
            <div className="flex justify-between">
                <a href={url}>
                    ...
                    </svg>) :<div className="w-10 h-10"></div>}
                </a>
                <a href={url} >
                    <img
                        src={srcImg}
                        alt="Speaker Photo"
                        className="object-cover h-[130px] w-[120px] top-[-60px] xl:w-[180px] xl:h-[187px] absolute xl:top-[-118px] right-0"
                    />
                </a> 
            </div>
            <div className="max-w-[312px] text-[#FFA100] text-[15px] font-[750] uppercase mt-6">
                {text1}
            </div>
            <div className="max-w-[212px] text-white text-[26px] xl:text-[30px] font-[750] uppercase mt-4">
                {text2}
            </div>
            <div className="max-w-[312px] text-white text-[16px] font-[400] mt-3">
                {text3}
            </div>
        </div>
    );
