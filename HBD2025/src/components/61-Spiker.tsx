...
function Speaker({ srcImg, index, text1, text2, text3, url }: speaker) {
    return (
        <div className= {`speakerBg gradient-border py-[40px] pl-2 pr-2  min-w-[430] min-h-[660px] rounded-[40px] -skew-x-10 relative ${index == 0 ? 'xl:mt-100 xl:mr-30 ' : ''}
        ${index == 2 ? 'xl:ml-100 xl:mr-30' : ''}
        ${index == 3 ? 'xl:-mt-100' : ''}
        `} >
            <div className="skew-x-10 flex flex-col h-full">
                ...
                <div className="flex-1 border-t-4 border-black">
                    <div className="max-w-[330px] text-white text-[21px] font-[200] uppercase mt-6">
                        {text1}
                    </div>
                    <div className="max-w-[212px] text-white text-[32px] xl:text-[30px] font-[750] uppercase mt-4">
                        {text2}
                    </div>
                    <div className="max-w-[250px] text-white text-[16px] font-[100] mt-3">
                        {text3}
                    </div>
                </div>
            </div>
