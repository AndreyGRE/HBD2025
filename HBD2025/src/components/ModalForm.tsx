...
export default function ModalForm() {
    ...
    return (
        <>
            ...
            <div
                onClick={openModal}
                className="cursor-pointer flex gap-2 bg-[#E95521] -skew-x-17 rounded-lg lg:px-[100px] xl:py-[10px]  w-full lg:w-fit   py-[10px] items-center justify-center text-white text-[20px] xl:text-[33px] font-[450] hover:opacity-80"
            >
