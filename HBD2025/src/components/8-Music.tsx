...
function App() {
    return (
        <div className="mt-[100px] xl:mt-[150px] lg:px-[100px] px-[27px]  relative ">
            {/* Мобильная версия */}
            <svg
                className="inset-0 w-full h-full absolute lg:hidden"
            ...
            <div className="relative z-10  grid-cols-10 items-center h-full  grid lg:hidden">
                <div className="text-white col-span-5 pl-12">
                    ...
                    <p className="text-[9px] leading-[120%] max-w-2xl ">
                        House Business Day — это не только про бизнес, но и про
                        вдохновение. Вас ждёт музыкальное шоу от The BeatLove,
                        официального трибьюта The Beatles. Атмосфера
                        ливерпульских 60-х, живой звук и энергия легендарной
                        четвёрки.
                    </p>
                </div>
                <img src={ImgMusicMob} alt="Концерт" className="col-span-5" />
            </div>
            ...
            {/* десктопная версия */}
            <svg
                className=" inset-0 w-full h-full hidden lg:absolute"
                xmlns="http://www.w3.org/2000/svg"
                width="1728"
                height="612"
            ...
            <div className="relative z-10  grid-cols-10 items-center h-full pl-20 hidden lg:grid">
